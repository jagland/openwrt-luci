...
----------------------------- Dynamic VLAN Assignment ------------------------
	...
	vlan_bridge = s:taboption("advanced", Flag, "vlan_bridge", translate("VLAN Bridge Prefix"), translate("Change VLAN Bridge prefix to br-vlan"))
	vlan_bridge.enabled = "br-vlan"
	vlan_bridge.disabled = "0"
	vlan_bridge.rmempty = true
